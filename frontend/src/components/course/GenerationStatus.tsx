...
export function GenerationStatus({ courseId, onComplete, onRegenerate }: GenerationStatusProps) {
  ...
  const confirmDialog = (
    <ConfirmDialog
      ...
      message="Regenerating will replace all existing modules, lessons, and quiz questions with new AI-generated content."
      confirmLabel="Regenerate course"
      cancelLabel="Cancel"
      confirmVariant="danger"
      loading={isRegenerating}
      onConfirm={handleRegenerateCourse}
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex items-center space-x-3">
                  ...
                  <p className="text-sm text-gray-600">or contact support if the issue persists.</p>
                </div>
              </div>
            </div>
          </CardBody>
